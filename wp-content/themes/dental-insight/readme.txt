...
= 0.2 =
	-- Checked theme with updated WP version 5.7.1.
...
= 0.2.5 =
	-- Added sticky header and site loader.

= 0.2.6 =
	-- Added Documentation.
	-- Added condition in the sections.
...
= 4.2 =
	...
	-- Responsive media css correction done.
...
Dental Insight bundles the following third-party resources:
...
* Pxhere Images,
	...
	Slider image, Copyright Waseem Farooq
	License: CC0 1.0 Universal (CC0 1.0)
