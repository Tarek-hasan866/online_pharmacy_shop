...
function dental_insight_customize_register( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'dental_insight_call', array(
		'selector' => '.info-box i',
		'render_callback' => 'dental_insight_customize_partial_dental_insight_call',
	) );
	...
	$wp_customize->add_setting('dental_insight_header_fb_target',
    array(
        'default' => true,
        'sanitize_callback' => 'dental_insight_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Dental_Insight_Toggle_Control( $wp_customize, 'dental_insight_header_fb_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'dental-insight'),
            'type' => 'toggle',
            'section' => 'dental_insight_urls',
            'active_callback' => 'dental_insight_social_dropdown'
        )
	...
	$wp_customize->add_setting('dental_insight_header_twt_target',
    array(
        'default' => true,
        'sanitize_callback' => 'dental_insight_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Dental_Insight_Toggle_Control( $wp_customize, 'dental_insight_header_twt_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'dental-insight'),
            'type' => 'toggle',
            'section' => 'dental_insight_urls',
	...
	$wp_customize->add_setting('dental_insight_header_ut_target',
    array(
        'default' => true,
        'sanitize_callback' => 'dental_insight_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Dental_Insight_Toggle_Control( $wp_customize, 'dental_insight_header_ut_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'dental-insight'),
            'type' => 'toggle',
            'section' => 'dental_insight_urls',
	...
	$wp_customize->add_setting('dental_insight_header_ins_target',
    array(
        'default' => true,
        'sanitize_callback' => 'dental_insight_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Dental_Insight_Toggle_Control( $wp_customize, 'dental_insight_header_ins_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'dental-insight'),
            'type' => 'toggle',
            'section' => 'dental_insight_urls',
