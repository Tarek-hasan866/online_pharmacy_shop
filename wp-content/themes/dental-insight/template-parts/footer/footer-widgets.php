...
<?php //Set widget areas classes based on user choice
    $dental_insight_footer_columns = get_theme_mod('dental_insight_footer_widget', '4');
    if ($dental_insight_footer_columns == '3') {
      $cols = 'col-lg-4 col-md-4';
    } elseif ($dental_insight_footer_columns == '4') {
      $cols = 'col-lg-3 col-md-3';
    } elseif ($dental_insight_footer_columns == '2') {
